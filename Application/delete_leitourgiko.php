...
<div id="center">
	<h1 align=center>Διαγραφή Δεδομένων</h1>
      <p align=center>Παρακαλώ διαγράψτε τα στοιχεία του πίνακα με βάση το ID του λειτουργικού</p>
	<form name="delete" method="post" action="delete_leitourgiko_exe.php">
