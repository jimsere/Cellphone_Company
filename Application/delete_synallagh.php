...
<div id="center">
	<h1 align=center>Διαγραφή Δεδομένων</h1>
      <p align=center>Παρακαλώ διαγράψτε τα στοιχεία του πίνακα με βάση το ID της συναλλαγής</p>
	<form name="delete" method="post" action="delete_synallagh_exe.php">
		<table width=300 border=0 align=center cellpadding=2 cellspacing=0>
			<tr>
				<td width=120 align=right><b>ID συναλλαγής:</b></td>
				<td width=180><input name="ID_SYNALLAGHS" type="text" size=10></td>
			</tr>
			<tr>
