...
<div id="center">
	<h1 align=center>Διαγραφή Δεδομένων</h1>
      <p align=center>Παρακαλώ διαγράψτε τα στοιχεία του πίνακα με βάση το Όνομα του κατασκευαστή</p>
	<form name="delete" method="post" action="delete_kataskeuasths_exe.php">
		<table width=300 border=0 align=center cellpadding=2 cellspacing=0>
			<tr>
				<td width=120 align=right><b>Όνομα κατασκευαστή:</b></td>
				<td width=180><input name="ONOMA_KATASKEYASTH" type="text" size=10></td>
			</tr>
			<tr>
