...
<div id="center">
	...
	<form name="insert" method="post" action="insert_pelaths_exe.php">
		<table width=300 border=0 align=center cellpadding=2 cellspacing=0>
			...
			<tr>
				...
				<td><input name="EPITHETO" type="text" size=10></td>
			</tr>
            <tr>
				<td width=120 align=right><b>Όνομα :</b></td>
				<td width=180><input name="ONOMA" type="text" size=10></td>
			</tr>
            <tr>
            ...
            <tr>
				<td width=120 align=right><b>Κινητό :</b></td>
