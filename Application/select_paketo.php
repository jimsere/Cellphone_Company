...
<table border=2 align=center>
	...
	<tr>
    <th colspan="5" bgcolor="0099cc">ΠΑΚΈΤΑ</th></tr>
    <tr><th bgcolor="66ff33" width=80>SMS</th>
		<th  bgcolor="66ff33" width=80>Δεδομένα</th>
        <th bgcolor="66ff33" width=80>Λεπτά ομιλίας</th>
        <th bgcolor="66ff33" width=80>ID πακέτου</th>

	</tr>

<?php
	$qry = "SELECT * FROM PAKETO";
