...
<div id="center">
	...
	<form name="insert" method="post" action="pararthma_exe.php">
		<table width=300 border=0 align=center cellpadding=2 cellspacing=0>
			...
			<tr>
				<td align=right><b>Πόλη :</b></td>
				<td><input name="POLH" type="text" size=10></td>
			</tr>
            <tr>
				<td width=120 align=right><b>Οδός :</b></td>
				<td width=180><input name="ODOS" type="text" size=10></td>
			</tr>
            <tr>
				<td width=120 align=right><b>Ταχυδρομικός κώδικας :</b></td>
				<td width=180><input name="TK" type="text" size=10></td>
			</tr>
            <tr>
				<td width=120 align=right><b>Τηλέφωνο :</b></td>
				<td width=180><input name="THLEFONO" type="text" size=10></td>
			</tr>
			<tr>
