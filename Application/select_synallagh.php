...
<table border=2 align=center>
	...
	<tr>
    <th colspan="5" bgcolor="0099cc">ΣΥΝΑΛΛΑΓΈΣ</th></tr>
    <tr><th bgcolor="66ff33" width=80>ID συναλλαγής</th>
		<th  bgcolor="66ff33" width=80>Ημ/ώρα</th>
        <th bgcolor="66ff33" width=80>Ποσό</th>
        <th bgcolor="66ff33" width=80>Κωδικός συμβολαίου</th>

	</tr>

<?php
	$qry = "SELECT * FROM SYNALLAGH";
