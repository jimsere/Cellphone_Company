...
<table border=2 align=center>
	...
	<tr>
    <th colspan="5" bgcolor="0099cc">ΚΑΤΑΣΚΕΥΑΣΤΈΣ</th></tr>
    <tr><th bgcolor="66ff33" width=80>Όνομα κατασκευαστή</th>
		<th  bgcolor="66ff33" width=80>Χώρα</th>
        <th bgcolor="66ff33" width=80>Έτος ίδρυσης</th>

	</tr>

<?php
	$qry = "SELECT * FROM KATASKEYASTHS";
