...
<table border=2 align=center>
	...
	<tr>
    <th colspan="6" bgcolor="0099cc">ΠΩΛΗΤΈΣ</th></tr>
    <tr><th bgcolor="66ff33" width=80>ID πωλητή</th>
		<th  bgcolor="66ff33" width=80>Όνομα</th>
        <th bgcolor="66ff33" width=80>Επίθετο</th>
        <th bgcolor="66ff33" width=80>Email</th>
        <th bgcolor="66ff33" width=80>ID πελάτη</th>
        <th bgcolor="66ff33" width=80>Κωδικός παραρτήματος</th>


	</tr>

<?php
	$qry = "SELECT * FROM PWLHTHS";
