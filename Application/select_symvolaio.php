...
<table border=2 align=center>
	...
	<tr>
    <th colspan="5" bgcolor="0099cc">ΣΥΜΒΌΛΑΙΑ</th></tr>
    <tr><th bgcolor="66ff33" width=80>Ημερομηνία έναρξης</th>
		<th  bgcolor="66ff33" width=80>Κωδικός πελάτη</th>
        <th bgcolor="66ff33" width=80>ID συμβολαίου</th>
        <th bgcolor="66ff33" width=80>Κωδικός πακέτου</th>
      

	</tr>

<?php
	$qry = "SELECT * FROM SYMVOLAIO";
